...
The data that we are dealing on is a data consist of 5110 rows and 12 columns.The data set record the 12 features that  includes physical measures, stroke status and related personal information of 5110 suspected stroke patients. We have the information on the patient's biological gender, the age of each patient,whether a patient has heart disease/hypertension 
