...
Figure 3.2.1 is an illustration of the kNN technique with only age and bmi as the features utilized in kNN, where 0 = the patient have not had stroke, 1 =  the patient had stroke(For demonstration purpose, we only sampled 400 rows of data from the cleaned stroke data set).
