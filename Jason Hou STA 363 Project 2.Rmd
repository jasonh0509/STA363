...
The model fitted with elastic net has the lowest RMSE of 59.34 (with $\alpha = 0.15$ and $\lambda = 5$) among the three models fitted model. Consider the range the price varies in the data set(from 0 to 1000), this RMSE indicates a relatively better predictive accuracy of the model, which also simultaneously balance bias and variance.
