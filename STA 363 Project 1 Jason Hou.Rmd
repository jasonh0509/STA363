...
for(i in 1:10){
  ...
  modelTrained<-glm(data=logisticTrain,family = binomial,Y~Sex+Vomiting+Temp+Age*Weight+BMI+Rash)
...
modelTotal<-glm(data=dengue,family = binomial,Y~Sex+Vomiting+Temp+Age*Weight+BMI+Rash)
...
knitr::kable(table(storage_modelTotal$Prediction, dengue$Y), caption= "Table x: Confusion Matrix of Predicting Dengue Status (Logistic Regerssion & 10 Fold CV) ", col = c("Not Dengue", "Dengue"))  
```

$$Sensitivity = \frac{3139}{752+3139}\approx 0.807$$

$$Specificity = \frac{946}{752+946}\approx 0.557$$
