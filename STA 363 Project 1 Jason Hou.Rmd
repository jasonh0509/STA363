...
We are working on the data set that records 5726 children in Vietnam who were suffered from dengue fever. The data set contains the  
...
```
Here we have a data point (a boy with height of 100cm and age of 8 year old), and we set our K for k-nearst neighbor equals to 3. Then, We look for the dengue status of the 3 nearest data point respect to this data point on the graph and check their dengue status, then we assign the dengue status that the majority of these 3 data points have as the predicted dengue status of this 8 year-old, 100cm boy. 
