...
,caption = "Table 7. Training RSS (Using Flipper Length to Split")
```
...
knitr::kable(summary(LSLR2)$coefficients,caption = "Table 8. LSLR Model Table Body Mss vs. Flipper Length")
```
...
knitr::kable(Tree_vs_LSLR,caption = "Table 9. RMSE of LSLR and Tree(Flipper Length) ")
...
knitr::kable(one_split_vs_two,caption = "Table 10. Penguin Body Mass Prediction RMSE of Root, One Split and Two Splits")
```
...
knitr::kable(Third_penguin,caption = "Table 11. Predicted Body Mass of 3rd Penguin in Data Set")
```
