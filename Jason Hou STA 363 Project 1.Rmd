...
```{r EDA Checking interaction, eval=FALSE, include=FALSE}
log_odd_sex_age<-logodds_plot(num_bins=50,bin_method = "equal_size", x = "BMI", y = "Age",reg_formula = y ~ x, grouping = "Y",data=dengue)
log_odd_sex_age
```
