...
The $\lambda = 2.7$ gives the best value for our test metric.
...
knitr::kable(improved,caption = "Table 9. Improved Amount of RMSE")
```
...
LSLR_and_Ridge<-data.frame("Type" = c("LSLR","Ridge") ,"Lambda" = lambda_final, "MSE" = MSE_final, "RMSE" = RMSE_final)
knitr::kable(LSLR_and_Ridge,caption = "")
```
